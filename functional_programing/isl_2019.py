isl_2019 = [
    ...
    {"team":"chennaiyin","match_played":16,"won":3,"drawn":8,"loss":5,"goal_for":11,"goal_acq":20,"goal_differ":-4,"points":17}
]

from functools import reduce
higest_points=list(filter(lambda team:team["points"]==reduce(lambda P1,P2:P1 if P1>P2 else P1,list(map(lambda team:team["points"],isl_2019))),isl_2019))
print(higest_points)


# lower_points=list(filter(lambda team:team["points"]==reduce(lambda p1,p2:p1 if p1<p2 else p2,list(map(lambda team:team["points"],isl_2019))),isl_2019))
# print(lower_points)
